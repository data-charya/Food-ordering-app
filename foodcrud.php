...
require_once ("./php/foodoperation.php");
?>
...
<main>
    <div class="container text-center">
        <a href="dash.php" style="text-decoration: none;"><h1 class="py-4 text-light rounded" style="background:#FF8800;font-size:40px"><p style="font-family: 'Fredoka One', cursive">Food Dashboard</p></h1></a>
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50" style="font-family:'Montserrat';">
                ...
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-hamburger' style=\"color:#fff\"></i>","Item Name", "item_name",""); ?>
                </div>
                <div class="col">
                    <?php inputElement("<i class='fas fa-rupee-sign' style=\"color:#fff\"></i>","Price", "item_price",""); ?>
                </div>
                </div>
                <div class="d-flex justify-content-center">
                       ...
                       if($result){
                           ...
                           while ($row = mysqli_fetch_assoc($result)){ ?>
                               ...
                               <tr>
                                   ...
                                   <td data-id="<?php echo $row['id']; ?>"><?php echo 'Rs.' . $row['item_price']; ?></td>
